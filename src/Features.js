...
export default class Features extends Component {
  render() {
    return (
      <Container maxWidth="1046px" sx={{mt: {xs: "660px", sm: "660px",md: "130px"}, backgroundColor: "#FAFAFA" }}>
        <Container>
          ...
          <Stack direction={{sm:"column", md:"row"}} sx={{mt: 6, width: "100%", justifyContent: "space-evenly"}}>
              <Stack direction="row" sx={{width: {sm:"100%", md:"50%"}, justifyContent: "space-evenly"}}>
                <Card elevation={1} sx={{width: "50%"}}>
