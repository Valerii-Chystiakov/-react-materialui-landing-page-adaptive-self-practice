    ...
    return (
        <div>
            <Container maxWidth="1046px" sx={{ top:"62px", position:"relative", mt: 15, backgroundColor: 'transparent' }}>
                <Container>
                    <Stack sx={{flexWrap:"wrap"}} spacing={1} mb={"70px"} direction={"row"} justifyContent={"space-between"} alignItems={"center"}>
                    <img width={"103px"}
                        height={"34px"}
                        style={{margin: '0px'}}
                            src={`${ClientsImg1}`}
                    ...
                    <Stack sx={{justifyContent:"space-between"}} px={"50px"} py={"30px"} backgroundColor={"secondary2.main"} direction={{sm:"column", md:"row"}}>
                        ...
                        <Paper
                        component="form"
                        sx={{ p: '1px 2px ', display: 'flex', alignItems: 'center', width: {sm:"100%", md:"50%"},maxWidth:"500px", margin:"auto" }}>
                            <TextField variant='filled'
                                sx={{ ml: 0, flex: 1 }}
                                label="Your Email"
                                inputProps={{ 'aria-label': 'enter your email to subscribe' }}
                            />
                            <Button type="button" variant="contained" color="primary" sx={{ height: "100%", p: 1.5, borderTopLeftRadius: 0,borderBottomLeftRadius: 0 }} aria-label="subscribe">
